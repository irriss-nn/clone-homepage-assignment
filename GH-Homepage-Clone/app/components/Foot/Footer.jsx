...
const SocialIcon = ({href, src, alt}) => (
  <li className='mr-4'>
    <a href={href}>
      <img src={src} height="18" width="22" className="d-block" loading="lazy" decoding="async" alt={alt} />
    </a>
  </li>
);
...
const LinksSection = ({title, links}) => (
  <div className='text-[#7d8590]'>
    <h2 className='font-medium mb-4 font-mono'>{title}</h2>
...
// Component to render a section of links under a title
const Footer = () => {
    // Data for the social icons
  const socialIcons = [
    { href: "#", src:"https://github.githubassets.com/images/modules/site/icons/footer/twitter.svg", alt: "Twitter" },
    { href: "#", src: "https://github.githubassets.com/images/modules/site/icons/footer/facebook.svg", alt: "Facebook" },
    { href: "#", src: "https://github.githubassets.com/images/modules/site/icons/footer/linkedin.svg", alt: "Linkined" },
    { href: "#", src: "https://github.githubassets.com/images/modules/site/icons/footer/youtube.svg", alt: "Youtube" },
    { href: "#", src: "https://github.githubassets.com/images/modules/site/icons/footer/twitch.svg", alt: "Twitch" },
    { href: "#", src: "https://github.githubassets.com/images/modules/site/icons/footer/tiktok.svg", alt: "TikTok" },
    { href: "#", src: "https://github.githubassets.com/images/modules/site/icons/footer/github-mark.svg", alt: "Github" },
  ];
  // Data for the sections of links in the footer
  const sections = [
    { title: "Product", links: [{ text: "Features", href: "#" }, 
        { text: "Community Forum", href: "#" },
        { text: "Security", href: "#" },
        { text: "Team", href: "#" },
        { text: "Enterprise", href: "#" },
        { text: "Custom Stories", href: "#" },
        { text: "The ReadME Project", href: "#" },
        { text: "Pricing", href: "#" },
        { text: "Resources", href: "#" },
        { text: "Roadmap", href: "#" },
        { text: "Compare GitHub", href: "#" }
        /*... other links */] 
    },

    { title: "Platform", links: [{ text: "Developer API", href: "#" }, 
        { text: "Partners", href: "#" },
        { text: "Electron", href: "#" },
        { text: "GitHub Desktop", href: "#" }] 
    },
    
    { title: "Support", links: [{ text: "Docs", href: "#" }, 
        { text: "Community Forum", href: "#" },
        { text: "Professional Services", href: "#" },
        { text: "Premium Support", href: "#" },
        { text: "Status", href: "#" },
        { text: "Skills", href: "#" },
        { text: "Contact GitHub", href: "#" }/*... other links */] 
    },

    { title: "Company", links: [{ text: "About", href: "#" },
        { text: "Blog", href: "#" },
        { text: "Careers", href: "#" },
        { text: "Press", href: "#" },
        { text: "Inclusion", href: "#" },
        { text: "Social Impact", href: "#" },
        { text: "Shop", href: "#" }/*... other links */]
    },
  ];
return (
    ...
    {/* Bottom section of the footer containing the social icons and some additional links */}
