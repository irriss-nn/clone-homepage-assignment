    ...
    <div className='max-w-[1280px] mx-auto'>
        ...
        <div className='relative z-[1]'>
            ...
            <div className='overflow-auto md:flex flex-col md:space-y-20 flex-1 py-20 md:p-10 p-5 my-6    justify-between md:min-w-[400px]'>
                <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Secret scanning</span>  automatically looks for partner patterns and prevents fraudulent use of accidentally committed secrets.</p>
                <div>
            ...
            {/* <div class="overflow-hidden col-md-6 rounded-right-3"><picture>
                ...
                <img class="width-full d-block height-auto js-build-in-item build-in-scale-fade build-in-animate" width="1288" height="992" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://github.githubassets.com/images/modules/site/home-campaign/illu-secret-scanning.png">
                </picture></div> */}
             <div className="overflow-hidden col-md-6 rounded-right-3">
                <motion.div initial={{scale:0.9, opacity:0}} whileInView={{scale:1, opacity:1}} transition={{type:'tween'}} className='rounded-r-md overflow-hidden flex items-center'>
                    <img className="width-full d-block height-auto js-build-in-item build-in-scale-fade build-in-animate" width="644" height="496" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://github.githubassets.com/images/modules/site/home-campaign/illu-secret-scanning.png" />
                </motion.div>
            </div>
            </HoverCard>
